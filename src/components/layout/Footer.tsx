        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              {/* Social Media Icons */}
              <Link href="https://www.facebook.com/share/1ALNnyV4yz/" className="text-muted-foreground hover:text-primary transition">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </Link>
              <Link href="https://www.instagram.com/taptifoodspices/?utm_source=qr&igsh=dXIxb2ZzemM1ZXZ4" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="https://x.com/Tapti_food" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </Link>
              <Link href="https://wa.me/919329216544" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/products" className="hover:text-primary transition">Seasonings</Link></li>
              <li><Link href="/wholesale" className="hover:text-primary transition">Wholesale</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/contact" className="hover:text-primary transition">Privacy Policy</Link></li>
              <li><Link href="/contact" className="hover:text-primary transition">Terms of Service</Link></li>
            </ul>
          </div>
        </div>
